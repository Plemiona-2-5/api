...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20210608085051_add_map_entity")]
    partial class add_map_entity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationCore.Entities.Map", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ApplicationCore.Entities.Village", b =>
                {
                    b.HasOne("ApplicationCore.Entities.Map", "Map")
                        .WithMany("Villages")
                        .HasForeignKey("MapId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
