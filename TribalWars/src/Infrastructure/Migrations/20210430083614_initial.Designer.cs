...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20210430083614_initial")]
            ...
            modelBuilder.Entity("ApplicationCore.Entities.Attack", b =>
                {
                    ...
                    b.Property<int>("AttackerVillageId")
                        .HasColumnType("int");

                    b.Property<int>("DefenderVillageId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApplicationCore.Entities.Attack", b =>
                {
                    b.HasOne("ApplicationCore.Entities.Village", "Village")
                        .WithMany("Attacks")
                        .HasForeignKey("AttackerVillageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
